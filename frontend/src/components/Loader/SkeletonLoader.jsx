...
export const SkeletonLoader = () => {
  return (
    <>
      <div className="animate-pulse space-x-4 max-w-3xl">
        ...
        <div className="bg-[#ebebeb] dark:bg-gray-300 rounded p-4 space-y-2">
      ...
      <div role="status" className="animate-pulse max-w-3xl mt-10">
        ...
        <div className="bg-gray-100 rounded dark:bg-gray-300">
          <div className="h-2.5 bg-gray-200 rounded w-3/4"></div>
          <div className="h-2.5 bg-gray-200 rounded w-2/3"></div>
        </div>

        <div className="h-4 bg-gray-200 rounded-md dark:bg-gray-300 w-1/2 mt-8"></div>
