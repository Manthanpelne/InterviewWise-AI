  ...
  return (
    <div className='fixed bg-black/40 z-50 inset-0 flex justify-center items-center w-full h-full'>
      ...
      <div className='relative w-[85%] md:w-auto bg-white p-5 md:p-8 flex flex-col overflow-hidden'>
       ...
       <svg onClick={onClose} className='w-6 h-6 cursor-pointer absolute top-3 right-3 transition-all duration-100 active:scale-95' viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
        ...
        {hideHeader && title && <h2 className='text-lg font-bold mb-4'>{title}</h2>}
        {children}
      </div>
    </div>
  );
